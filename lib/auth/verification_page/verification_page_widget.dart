...
class _VerificationPageWidgetState extends State<VerificationPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.responseRequestVerification = await ResendVerificationCall.call(
        email: FFAppState().currentUser.email,
        jwt: currentAuthenticationToken,
      );

      if ((_model.responseRequestVerification?.succeeded ?? true)) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              ResendVerificationCall.resendVerificationMessage(
                (_model.responseRequestVerification?.jsonBody ?? ''),
              )!,
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: [
                wrapWithModel(
                  model: _model.authHeadingModel,
                  updateCallback: () => safeSetState(() {}),
                  child: AuthHeadingWidget(
                    headingText: 'Verifikasi\nEmail',
                  ),
                ),
                Column(
                  mainAxisSize: MainAxisSize.max,
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  _model.responseResendVerification =
                                      await ResendVerificationCall.call(
                                    email: FFAppState().currentUser.email,
                                    jwt: currentAuthenticationToken,
                                  );

                                  if ((_model.responseResendVerification
                                          ?.succeeded ??
                                      true)) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          ResendVerificationCall
                                            ...
                                            (_model.responseRequestVerification
                                                    ?.jsonBody ??
                                                ''),
                                          )!,
                                          style: FlutterFlowTheme.of(context)
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.responseVerification =
                                      await VerificationCall.call(
                                    email: FFAppState().currentUser.email,
                                    otp: _model.textController.text,
                                  );

                                  if ((_model.responseVerification?.succeeded ??
                                      true)) {
                                    context
