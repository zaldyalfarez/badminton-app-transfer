              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                                  ...
                                  onPressed: () async {
                                    ...
                                    if ((_model.registerResponse?.succeeded ??
                                      ...
                                      await authManager.signIn(
                                        authenticationToken: RegisterCall.jwt(
                                          (_model.registerResponse?.jsonBody ??
                                              ''),
                                        ),
                                      );
                                      FFAppState().updateCurrentUserStruct(
                                        (e) => e
                                          ..verified = RegisterCall.isVerified(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          )
                                          ..id = RegisterCall.userId(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          )
                                          ..name = RegisterCall.userName(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          )
                                          ..email = RegisterCall.userEmail(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          )
                                          ..role = RegisterCall.userRole(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          )
                                          ..image = RegisterCall.userImage(
                                            (_model.registerResponse
                                                    ?.jsonBody ??
                                                ''),
                                          ).toString(),
                    ...
                    wrapWithModel(
                      model: _model.authFooterLoginModel,
                      updateCallback: () => safeSetState(() {}),
                      child: AuthFooterLoginWidget(),
                    ),
                  ],
                ),
              ),
