...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    badmintonAppAuthUserSubject.add(
      BadmintonAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BadmintonAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BadmintonAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BadmintonAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    badmintonAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BadmintonAppAuthUser? currentUser;
