                              ...
                              onPressed: () async {
                                ...
                                if ((_model.loginResponse?.succeeded ?? true)) {
                                  ...
                                  FFAppState().updateCurrentUserStruct(
                                    (e) => e
                                      ..verified = LoginCall.userVerified(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      )
                                      ..id = LoginCall.userId(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      )
                                      ..name = LoginCall.userName(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      )
                                      ..email = LoginCall.userEmail(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      )
                                      ..role = LoginCall.userRole(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      )
                                      ..image = LoginCall.userImage(
                                        (_model.loginResponse?.jsonBody ?? ''),
                                      ).toString(),
                                  );
