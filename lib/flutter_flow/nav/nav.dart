...
class AppStateNotifier extends ChangeNotifier {
  ...
  BadmintonAppAuthUser? initialUser;
  BadmintonAppAuthUser? user;
  ...
  void update(BadmintonAppAuthUser newUser) {
    final shouldUpdate =
      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: ExamPageWidget.routeName,
              path: ExamPageWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ExamPageWidget(
                ujianId: params.getParam(
                  'ujianId',
                  ParamType.int,
                ),
                ujianName: params.getParam(
                  'ujianName',
                  ParamType.String,
                ),
                ujianDurasi: params.getParam(
                  'ujianDurasi',
                  ParamType.int,
                ),
              ),
            ...
            FFRoute(
              name: ExamResultWidget.routeName,
              path: ExamResultWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ExamResultWidget(
                userUjianId: params.getParam(
                  'userUjianId',
                  ParamType.int,
                ),
              ),
            ...
            FFRoute(
              name: StatisticDetailWidget.routeName,
              path: StatisticDetailWidget.routePath,
              requireAuth: true,
              builder: (context, params) => StatisticDetailWidget(
                ujianId: params.getParam(
                  'ujianId',
                  ParamType.int,
                ),
                ujianTitle: params.getParam(
                  'ujianTitle',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              name: StatisticHistoryWidget.routeName,
              path: StatisticHistoryWidget.routePath,
              requireAuth: true,
              builder: (context, params) => StatisticHistoryWidget(
                ujianId: params.getParam(
                  'ujianId',
                  ParamType.int,
                ),
            ...
            FFRoute(
              name: ChangeProfileWidget.routeName,
              path: ChangeProfileWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ChangeProfileWidget(),
            ),
            FFRoute(
              name: AugmentedRealityWidget.routeName,
              path: AugmentedRealityWidget.routePath,
              requireAuth: true,
              builder: (context, params) => AugmentedRealityWidget(
                practiceName: params.getParam(
                  'practiceName',
                  ParamType.String,
                ),
                modelAR: params.getParam(
                  'modelAR',
                  ParamType.String,
                ),
              ),
